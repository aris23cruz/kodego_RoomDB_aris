...
import com.kodego.inventory.app.roomdemo.databinding.ActivityMainBinding
import com.kodego.inventory.app.roomdemo.databinding.UpdateDialogBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSave.setOnClickListener(){
            ...
            val salary:Int = binding.etSalary.text.toString().toInt()
